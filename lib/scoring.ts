 ...
 *  4. Optional: replacement-value layer
 *  5. Optional: SB scarcity boost (disabled for punt-SB strategy)
...
export function computeDiagnostics(ranked: ScoredPlayer[]): Diagnostics {
  ...
  return {
    pitchersTop20, pitchersTop50, pitchersTop100,
    longestPitcherStreak: maxP,
    longestHitterStreak:  maxH,
    totalTiers,
    posEdge20Plus,
    negEdge20Plus,
  }
